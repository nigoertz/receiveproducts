sap.ui.define([
	...
	return Opa5.extend("com.generalgoods.mm.gtwo.receiveproducts.receiveproducts.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.generalgoods.mm.gtwo.receiveproducts.receiveproducts",
					async: true
				},
				hash: oOptions.hash,
