sap.ui.define([
    ...
    return BaseController.extend("com.generalgoods.mm.gtwo.receiveproducts.receiveproducts.controller.Worklist", {
        ...
        onPressNavigation : function (oEvent) {
            ...
            let oData = this.getModel().getProperty(sPath);
        ...
        _showObject : function (oItem) {
            this.getRouter().navTo("object", {
                objectId: oItem.getBindingContext().getPath().substring("/LieferungenSet".length)
            });
        },
